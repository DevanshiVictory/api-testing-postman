...
echo "# api-testing-postman" >> fileee.txt

git branch -M main
git add .
git commit -m "Initial commit"
git remote add origin https://github.com/DevanshiVictory/api-testing-postman.git
git remote -v
git push -u origin main

git clone https://github.com/DevanshiVictory/api-testing-postman
